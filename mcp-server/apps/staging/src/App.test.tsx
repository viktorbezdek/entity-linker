...
describe("Staging Review App stub", () => {
  it("renders the app container", () => {
    const { container } = render(<App />);
    expect(container.querySelector('[data-testid="staging-app"]')).not.toBeNull();
  });

  it("renders the loaded message", () => {
    const { getByText } = render(<App />);
    expect(getByText("Staging Review App loaded")).toBeTruthy();
  });
